...
import opera.Opera;
import strutturaMuseo.museoAndAdmin.SalaFisica;
import strutturaMuseo.museoAndAdmin.SalaVirtuale;
...
public final class Mostra extends Observable {
    ...
    void setCostoTicket(int costoTicket){
    ...
    void setSale(Set<Sala> sale, boolean ancheOnline){
        this.sale = sale;
    ...
    void setOpereMostra(List<Opera> opereMostra){
    ...
    void setPostiTotali(int postiTotali){
        this.postiTotali = postiTotali;
    }

    void setIncassoObiettivo(int incassoObiettivo){
     ...
     */
    List<Acquirente> getVisitatoriMostra(){
